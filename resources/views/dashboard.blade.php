    ...
    <div class="activity-card {{ $log->current_status === 'done' ? 'activity-card--done' : 'activity-card--pending' }}">
        ...
        <div class="activity-card__assignment">
            ...
            @if($log->assignedByUser)
                <span class="text-muted">by {{ $log->assignedByUser->name }} at {{ $log->assigned_at->format('M j, Y, H:i') }}</span>
            @endif
        </div>
        @endif
            ...
            <div class="timeline__entry">
                ...
                <div class="timeline__content">
                    <div class="timeline__meta">
                        ...
                        <span class="timeline__time">{{ $update->updated_at_time->format('M j, Y, h:i A') }}</span>
                    </div>
                    @if($update->remark)
